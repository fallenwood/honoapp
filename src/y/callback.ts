 ...
 */
exports.callbackHandler = (update: any, origin: any, doc: any) => {
  const room = doc.name
  const dataToSend = {
    room,
    data: {}
 ...
 * @param {Object} data
 */
const callbackRequest = (url: any, timeout: any, data: any) => {
 ...
 * @param {import('./utils.cjs').WSSharedDoc} doc
 */
const getContent = (objName: any, objType: any, doc: any) => {
  switch (objType) {
